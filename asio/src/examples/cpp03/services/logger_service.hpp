...
class logger_service
  : public ModioAsio::execution_context::service
{
public:
  ...
  logger_service(ModioAsio::execution_context& context)
    : ModioAsio::execution_context::service(context),
      work_io_context_(),
      work_(ModioAsio::make_work_guard(work_io_context_)),
      work_thread_(new ModioAsio::thread(
            boost::bind(&ModioAsio::io_context::run, &work_io_context_)))
  {
  }
  ...
  void use_file(impl_type& /*impl*/, const std::string& file)
  {
    ...
    ModioAsio::post(work_io_context_, boost::bind(
...
private:
  ...
  ModioAsio::io_context work_io_context_;
  ...
  /// immediately.
  ModioAsio::executor_work_guard<
      ModioAsio::io_context::executor_type> work_;

  /// Thread used for running the work io_context's run loop.
  boost::scoped_ptr<ModioAsio::thread> work_thread_;
