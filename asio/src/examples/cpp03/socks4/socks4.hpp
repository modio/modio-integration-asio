...
public:
  ...
  boost::array<ASIO_NAMESPACE::const_buffer, 7> buffers() const
  {
    boost::array<ASIO_NAMESPACE::const_buffer, 7> bufs =
    {
      {
...
public:
  ...
  boost::array<ASIO_NAMESPACE::mutable_buffer, 5> buffers()
  {
    boost::array<ASIO_NAMESPACE::mutable_buffer, 5> bufs =
    {
      {
        ASIO_NAMESPACE::buffer(&null_byte_, 1),
