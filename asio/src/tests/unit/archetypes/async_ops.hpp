...
{
  typedef typename ASIO_NAMESPACE::async_completion<CompletionToken,
    void()>::completion_handler_type handler_type;

  ASIO_NAMESPACE::async_completion<CompletionToken,
    void()> completion(token);

  typename ASIO_NAMESPACE::associated_allocator<handler_type>::type a
    = ASIO_NAMESPACE::get_associated_allocator(completion.completion_handler);

  typename ASIO_NAMESPACE::associated_executor<handler_type>::type ex
    = ASIO_NAMESPACE::get_associated_executor(completion.completion_handler);
...
template <typename CompletionToken>
ASIO_INITFN_RESULT_TYPE(CompletionToken, void(ASIO_NAMESPACE::error_code))
async_op_ec_0(bool ok, ASIO_MOVE_ARG(CompletionToken) token)
{
  typedef typename ASIO_NAMESPACE::async_completion<CompletionToken,
    void(ASIO_NAMESPACE::error_code)>::completion_handler_type handler_type;

  ASIO_NAMESPACE::async_completion<CompletionToken,
    void(ASIO_NAMESPACE::error_code)> completion(token);
  ...
  else
  {
    ex.post(
        bindns::bind(
          ASIO_MOVE_CAST(handler_type)(completion.completion_handler),
          ASIO_NAMESPACE::error_code(ASIO_NAMESPACE::error::operation_aborted)), a);
  }
...
{
  typedef typename ASIO_NAMESPACE::async_completion<CompletionToken,
    void(ASIO_NAMESPACE::error_code, int)>::completion_handler_type
      handler_type;

  ASIO_NAMESPACE::async_completion<CompletionToken,
    void(ASIO_NAMESPACE::error_code, int)> completion(token);
  ...
  if (ok)
  {
    ex.post(
        bindns::bind(
          ASIO_MOVE_CAST(handler_type)(completion.completion_handler),
          ASIO_NAMESPACE::error_code(), 42), a);
  }
  else
  {
    ex.post(
        bindns::bind(
          ASIO_MOVE_CAST(handler_type)(completion.completion_handler),
          ASIO_NAMESPACE::error_code(ASIO_NAMESPACE::error::operation_aborted),
          0), a);
  }
...
template <typename CompletionToken>
ASIO_INITFN_RESULT_TYPE(CompletionToken,
    void(ASIO_NAMESPACE::error_code, int, double))
async_op_ec_2(bool ok, ASIO_MOVE_ARG(CompletionToken) token)
{
  typedef typename ASIO_NAMESPACE::async_completion<CompletionToken,
    void(ASIO_NAMESPACE::error_code, int, double)>::completion_handler_type
      handler_type;

  ASIO_NAMESPACE::async_completion<CompletionToken,
    void(ASIO_NAMESPACE::error_code, int, double)> completion(token);
  ...
  if (ok)
  {
    ex.post(
        bindns::bind(
          ASIO_MOVE_CAST(handler_type)(completion.completion_handler),
          ASIO_NAMESPACE::error_code(), 42, 2.0), a);
  }
  else
  {
    ex.post(
...
template <typename CompletionToken>
ASIO_INITFN_RESULT_TYPE(CompletionToken,
    void(ASIO_NAMESPACE::error_code, int, double, char))
async_op_ec_3(bool ok, ASIO_MOVE_ARG(CompletionToken) token)
{
  typedef typename ASIO_NAMESPACE::async_completion<CompletionToken,
    void(ASIO_NAMESPACE::error_code, int, double, char)>::completion_handler_type
      handler_type;

  ASIO_NAMESPACE::async_completion<CompletionToken,
    void(ASIO_NAMESPACE::error_code, int, double, char)> completion(token);
  ...
  if (ok)
  {
    ex.post(
        bindns::bind(
          ASIO_MOVE_CAST(handler_type)(completion.completion_handler),
          ASIO_NAMESPACE::error_code(), 42, 2.0, 'a'), a);
  }
  else
  {
    ex.post(
