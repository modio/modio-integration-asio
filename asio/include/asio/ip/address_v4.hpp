...
/**
 * The ModioAsio::ip::address_v4 class provides the ability to use and
...
#else
  typedef ModioAsio::detail::array<unsigned char, 4> bytes_type;
#endif
...
private:
  ...
  ModioAsio::detail::in4_addr_type addr_;
};
...
template <>
struct hash<ModioAsio::ip::address_v4>
{
  std::size_t operator()(const ModioAsio::ip::address_v4& addr)
    const ASIO_NOEXCEPT
  {
