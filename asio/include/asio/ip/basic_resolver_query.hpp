...
/**
 * The ModioAsio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const ModioAsio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  ModioAsio::detail::addrinfo_type hints_;
