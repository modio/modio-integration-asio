...
struct is_match_condition
{
  ...
  enum
  {
    value = ASIO_NAMESPACE::is_function<
        typename ASIO_NAMESPACE::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until ASIO_NAMESPACE::read_until
 *
 ...
 * std::size_t n = ASIO_NAMESPACE::read_until(s,
 *     ASIO_NAMESPACE::dynamic_buffer(data), '\n');
...
std::size_t read_until(SyncReadStream& s,
    ...
    char delim, ASIO_NAMESPACE::error_code& ec,
    typename constraint<
      is_dynamic_buffer_v1<typename decay<DynamicBuffer_v1>::type>::value
    >::type = 0,
    typename constraint<
 ...
 * @code std::string data;
 * std::size_t n = ASIO_NAMESPACE::read_until(s,
 *     ASIO_NAMESPACE::dynamic_buffer(data), boost::regex("\r\n"));
 * std::string line = data.substr(0, n);
 * data.erase(0, n); @endcode
 * After the @c read_until operation completes successfully, the string @c data
 * contains the delimiter:
...
std::size_t read_until(SyncReadStream& s,
    ASIO_MOVE_ARG(DynamicBuffer_v1) buffers,
    const boost::regex& expr, ASIO_NAMESPACE::error_code& ec,
    typename constraint<
      is_dynamic_buffer_v1<typename decay<DynamicBuffer_v1>::type>::value
    >::type = 0,
    typename constraint<
 ...
 * @code typedef ASIO_NAMESPACE::buffers_iterator<
 *     ASIO_NAMESPACE::const_buffers_1> iterator;
 *
 ...
 * ...
 * std::string data;
 * ASIO_NAMESPACE::read_until(s, data, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * ASIO_NAMESPACE::read_until(s, data, match_char('a'));
 * @endcode
 */
...
std::size_t read_until(SyncReadStream& s,
    ASIO_MOVE_ARG(DynamicBuffer_v1) buffers,
    MatchCondition match_condition, ASIO_NAMESPACE::error_code& ec,
    typename constraint<
      is_match_condition<MatchCondition>::value
    >::type = 0,
    typename constraint<
 ...
 * @code ASIO_NAMESPACE::streambuf b;
 * ASIO_NAMESPACE::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    ASIO_NAMESPACE::basic_streambuf<Allocator>& b, char delim);
...
std::size_t read_until(SyncReadStream& s,
    ASIO_NAMESPACE::basic_streambuf<Allocator>& b,
    ASIO_STRING_VIEW_PARAM delim, ASIO_NAMESPACE::error_code& ec);
 ...
 * @code ASIO_NAMESPACE::streambuf b;
 * ASIO_NAMESPACE::read_until(s, b, boost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    ASIO_NAMESPACE::basic_streambuf<Allocator>& b, const boost::regex& expr);
 ...
 * @code typedef ASIO_NAMESPACE::buffers_iterator<
 *     ASIO_NAMESPACE::streambuf::const_buffers_type> iterator;
 *
 * std::pair<iterator, bool>
 * match_whitespace(iterator begin, iterator end)
 * {
 ...
 * ASIO_NAMESPACE::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * ASIO_NAMESPACE::streambuf b;
 * ASIO_NAMESPACE::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    ASIO_NAMESPACE::basic_streambuf<Allocator>& b, MatchCondition match_condition,
...
/*@}*/
/**
 * @defgroup async_read_until ASIO_NAMESPACE::async_read_until
 *
 ...
 * @code std::string data;
 * ...
 * void handler(const ASIO_NAMESPACE::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::string line = data.substr(0, n);
 ...
 * }
 * ...
 * ASIO_NAMESPACE::async_read_until(s, data, '\n', handler); @endcode
 ...
 * ...
 * std::string data;
 * ASIO_NAMESPACE::async_read_until(s, data, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * ASIO_NAMESPACE::async_read_until(s, data, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
 ...
 * }
 * ...
 * ASIO_NAMESPACE::async_read_until(s, b, '\n', handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * }
 * ...
 * ASIO_NAMESPACE::async_read_until(s, b, boost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * ASIO_NAMESPACE::streambuf b;
 * ASIO_NAMESPACE::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * ASIO_NAMESPACE::streambuf b;
 * ASIO_NAMESPACE::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
