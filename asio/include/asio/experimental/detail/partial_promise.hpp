...
struct partial_promise
{
  ...
  {
    return ModioAsio::detail::suspend_always{};
  }
  ...
  auto final_suspend() noexcept
  {
    struct awaitable_t
    {
      ...
      auto await_suspend(ModioAsio::detail::coroutine_handle<>) noexcept
      {
...
struct coroutine_traits<
    coroutine_handle<ModioAsio::experimental::detail::partial_promise>,
    Args...>
{
  using promise_type = ModioAsio::experimental::detail::partial_promise;
};
