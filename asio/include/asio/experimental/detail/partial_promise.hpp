...
struct partial_promise
{
  ...
  {
    return ASIO_NAMESPACE::detail::suspend_always{};
  }
  ...
  auto final_suspend() noexcept
  {
    struct awaitable_t
    {
      ...
      auto await_suspend(ASIO_NAMESPACE::detail::coroutine_handle<>) noexcept
      {
...
struct coroutine_traits<
    coroutine_handle<ASIO_NAMESPACE::experimental::detail::partial_promise>,
    Args...>
{
  using promise_type = ASIO_NAMESPACE::experimental::detail::partial_promise;
};
