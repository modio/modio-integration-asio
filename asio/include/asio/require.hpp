 ...
 * expression <tt>ModioAsio::require(E, P0, Pn...)</tt> for some
 ...
 *   <tt>ModioAsio::require(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>ModioAsio::require(ModioAsio::require(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>ModioAsio::require(ModioAsio::require(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>ModioAsio::require(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>ModioAsio::require(std::declval<T>(),
 ...
 * type of the expression <tt>ModioAsio::require(std::declval<T>(),
