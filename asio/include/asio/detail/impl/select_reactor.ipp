...
select_reactor::select_reactor(ModioAsio::execution_context& ctx)
    ...
    const ModioAsio::error_code& /*ec*/, std::size_t /*bytes_transferred*/)
{
  if (owner)
  {
    ...
    ModioAsio::detail::mutex::scoped_lock lock(reactor->mutex_);
    ...
    ModioAsio::detail::signal_blocker sb;
    reactor->thread_ =
      new ModioAsio::detail::thread(thread_function(reactor));
  }
}
#endif // defined(ASIO_HAS_IOCP)
