...
ModioAsio::error_code winrt_ssocket_service_base::close(
    winrt_ssocket_service_base::base_implementation_type& impl,
    ...
    void* addr, std::size_t addr_len, ModioAsio::error_code& ec) const
{
  ...
  {
    ec = ModioAsio::error_code(e->HResult,
        ModioAsio::system_category());
    return addr_len;
  }
}

ModioAsio::error_code winrt_ssocket_service_base::do_set_option(
    winrt_ssocket_service_base::base_implementation_type& impl,
...
ModioAsio::error_code winrt_ssocket_service_base::do_connect(
    winrt_ssocket_service_base::base_implementation_type& impl,
    ...
    const void* addr, winrt_async_op<void>* op, bool is_continuation)
{
  ...
  case ASIO_OS_DEF(AF_INET6):
    ...
    break;
  default:
    op->ec_ = ModioAsio::error::address_family_not_supported;
    break;
  }
  ...
  {
    op->ec_ = ModioAsio::error_code(
        e->HResult, ModioAsio::system_category());
    scheduler_.post_immediate_completion(op, is_continuation);
  }
}
    ...
    socket_base::message_flags flags, ModioAsio::error_code& ec)
{
  ...
  try
  {
    buffer_sequence_adapter<ModioAsio::const_buffer,
      ModioAsio::const_buffer> bufs(ModioAsio::buffer(data));
      ...
      winrt_async_op<unsigned int>* op, bool is_continuation)
{
  ...
  {
    op->ec_ = ModioAsio::error_code(e->HResult,
        ModioAsio::system_category());
    scheduler_.post_immediate_completion(op, is_continuation);
  }
}
    ...
    socket_base::message_flags flags, ModioAsio::error_code& ec)
{
  ...
  try
  {
    buffer_sequence_adapter<ModioAsio::mutable_buffer,
        ModioAsio::mutable_buffer> bufs(ModioAsio::buffer(data));
