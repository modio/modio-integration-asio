...
private:
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers& buffers, ASIO_NAMESPACE::error_code& ec);
  size_t write_some_at(implementation_type& impl, uint64_t offset,
      const null_buffers& buffers, ASIO_NAMESPACE::error_code& ec);
  ...
  ASIO_DECL size_t do_write(implementation_type& impl,
      uint64_t offset, const ASIO_NAMESPACE::const_buffer& buffer,
      ASIO_NAMESPACE::error_code& ec);
  ...
  ASIO_DECL size_t do_read(implementation_type& impl,
      uint64_t offset, const ASIO_NAMESPACE::mutable_buffer& buffer,
      ASIO_NAMESPACE::error_code& ec);
