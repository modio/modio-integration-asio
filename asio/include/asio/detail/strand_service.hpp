...
class strand_service
  : public ASIO_NAMESPACE::detail::service_base<strand_service>
{
private:
...
public:
  ...
  ASIO_DECL explicit strand_service(ASIO_NAMESPACE::io_context& io_context);
...
private:
  ...
  ASIO_DECL static void do_complete(void* owner,
      operation* base, const ASIO_NAMESPACE::error_code& ec,
