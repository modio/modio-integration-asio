...
class strand_service
  : public ModioAsio::detail::service_base<strand_service>
{
private:
...
public:
  ...
  ASIO_DECL explicit strand_service(ModioAsio::io_context& io_context);
...
private:
  ...
  ASIO_DECL static void do_complete(void* owner,
      operation* base, const ModioAsio::error_code& ec,
