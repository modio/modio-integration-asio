...
public:
  ...
  // Destroy a socket implementation.
  ASIO_DECL ASIO_NAMESPACE::error_code close(
      base_implementation_type& impl, ASIO_NAMESPACE::error_code& ec);
  ...
  ASIO_NAMESPACE::error_code cancel(base_implementation_type&,
  ...
  ASIO_NAMESPACE::error_code io_control(base_implementation_type&,
  ...
  ASIO_NAMESPACE::error_code non_blocking(base_implementation_type&,
  ...
  ASIO_NAMESPACE::error_code native_non_blocking(base_implementation_type&,
      bool, ASIO_NAMESPACE::error_code& ec)
  {
    ec = ASIO_NAMESPACE::error::operation_not_supported;
    return ec;
...
protected:
  ...
  ASIO_DECL std::size_t do_get_endpoint(
      ...
      void* addr, std::size_t addr_len, ASIO_NAMESPACE::error_code& ec) const;

  // Helper function to set a socket option.
  ASIO_DECL ASIO_NAMESPACE::error_code do_set_option(
  ...
  ASIO_DECL void do_get_option(
      ...
      std::size_t* optlen, ASIO_NAMESPACE::error_code& ec) const;

  // Helper function to perform a synchronous connect.
  ASIO_DECL ASIO_NAMESPACE::error_code do_connect(
      base_implementation_type& impl,
      const void* addr, ASIO_NAMESPACE::error_code& ec);
  ...
  ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const ASIO_NAMESPACE::const_buffer& data,
      socket_base::message_flags flags, ASIO_NAMESPACE::error_code& ec);

  // Helper function to start an asynchronous send.
  ASIO_DECL void start_send_op(base_implementation_type& impl,
      const ASIO_NAMESPACE::const_buffer& data, socket_base::message_flags flags,
  ...
  ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const ASIO_NAMESPACE::mutable_buffer& data,
      socket_base::message_flags flags, ASIO_NAMESPACE::error_code& ec);

  // Helper function to start an asynchronous receive.
  ASIO_DECL void start_receive_op(base_implementation_type& impl,
      const ASIO_NAMESPACE::mutable_buffer& data, socket_base::message_flags flags,
