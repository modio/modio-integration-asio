...
public:
  ...
  // Destroy a socket implementation.
  ASIO_DECL ModioAsio::error_code close(
      base_implementation_type& impl, ModioAsio::error_code& ec);
  ...
  ModioAsio::error_code cancel(base_implementation_type&,
  ...
  ModioAsio::error_code io_control(base_implementation_type&,
  ...
  ModioAsio::error_code non_blocking(base_implementation_type&,
  ...
  ModioAsio::error_code native_non_blocking(base_implementation_type&,
      bool, ModioAsio::error_code& ec)
  {
    ec = ModioAsio::error::operation_not_supported;
    return ec;
...
protected:
  ...
  ASIO_DECL std::size_t do_get_endpoint(
      ...
      void* addr, std::size_t addr_len, ModioAsio::error_code& ec) const;

  // Helper function to set a socket option.
  ASIO_DECL ModioAsio::error_code do_set_option(
  ...
  ASIO_DECL void do_get_option(
      ...
      std::size_t* optlen, ModioAsio::error_code& ec) const;

  // Helper function to perform a synchronous connect.
  ASIO_DECL ModioAsio::error_code do_connect(
      base_implementation_type& impl,
      const void* addr, ModioAsio::error_code& ec);
  ...
  ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const ModioAsio::const_buffer& data,
      socket_base::message_flags flags, ModioAsio::error_code& ec);

  // Helper function to start an asynchronous send.
  ASIO_DECL void start_send_op(base_implementation_type& impl,
      const ModioAsio::const_buffer& data, socket_base::message_flags flags,
  ...
  ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const ModioAsio::mutable_buffer& data,
      socket_base::message_flags flags, ModioAsio::error_code& ec);

  // Helper function to start an asynchronous receive.
  ASIO_DECL void start_receive_op(base_implementation_type& impl,
      const ModioAsio::mutable_buffer& data, socket_base::message_flags flags,
