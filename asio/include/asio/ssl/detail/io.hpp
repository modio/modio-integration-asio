...
std::size_t io(Stream& next_layer, stream_core& core,
    const Operation& op, ModioAsio::error_code& ec)
{
  ModioAsio::error_code io_ec;
  ...
  case engine::want_input_and_retry:
    ...
    {
      core.input_ = ModioAsio::buffer(core.input_buffer_,
...
class io_op
  : public ModioAsio::detail::base_from_cancellation_state<Handler>
{
public:
  io_op(Stream& next_layer, stream_core& core,
      const Operation& op, Handler& handler)
    : ModioAsio::detail::base_from_cancellation_state<Handler>(handler),
  ...
  io_op(const io_op& other)
    : ModioAsio::detail::base_from_cancellation_state<Handler>(other),
  ...
  io_op(io_op&& other)
    : ModioAsio::detail::base_from_cancellation_state<Handler>(
        ASIO_MOVE_CAST(
          ModioAsio::detail::base_from_cancellation_state<Handler>)(
            other)),
      next_layer_(other.next_layer_),
      ...
      do
      {
        ...
        case engine::want_input_and_retry:
          ...
          if (core_.expiry(core_.pending_read_) == core_.neg_infin())
          {
            ...
            next_layer_.async_read_some(
                ModioAsio::buffer(core_.input_buffer_),
        ...
        case engine::want_output:
          ...
          if (core_.expiry(core_.pending_write_) == core_.neg_infin())
          {
            ...
            ModioAsio::async_write(next_layer_,
        ...
        default:
          ...
          if (start)
          {
            ...
            next_layer_.async_read_some(
                ModioAsio::buffer(core_.input_buffer_, 0),
                ASIO_MOVE_CAST(io_op)(*this));
        ...
        case engine::want_input_and_retry:
          ...
          {
            ec_ = ModioAsio::error::operation_aborted;
            break;
          }
    ...
    io_op<Stream, Operation, Handler>* this_handler)
{
  return this_handler->start_ == 0 ? true
    : ModioAsio::asio_handler_cont_helpers::is_continuation(this_handler->handler_);
}
