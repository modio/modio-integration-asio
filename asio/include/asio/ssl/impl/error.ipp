...
class ssl_category : public ASIO_NAMESPACE::error_category
{
public:
...
{
  return ASIO_NAMESPACE::error::get_ssl_category();
}
...
class stream_category : public ASIO_NAMESPACE::error_category
{
public:
  const char* name() const ASIO_ERROR_CATEGORY_NOEXCEPT
  {
