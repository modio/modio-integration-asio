...
/**
 * @par Example
 * @code ASIO_NAMESPACE::awaitable<void> my_coroutine()
 * {
 *   ASIO_NAMESPACE::cancellation_state cs
 *     = co_await ASIO_NAMESPACE::this_coro::cancellation_state;
 *
 *   // ...
 *
 *   if (cs.cancelled() != ASIO_NAMESPACE::cancellation_type::none)
 *     // ...
 * } @endcode
 */
#if defined(ASIO_HAS_CONSTEXPR) || defined(GENERATING_DOCUMENTATION)
 ...
 * @code ASIO_NAMESPACE::awaitable<void> my_coroutine()
 * {
 *   co_await ASIO_NAMESPACE::this_coro::reset_cancellation_state();
 *
 *   // ...
 * } @endcode
 *
 * @note The cancellation state is shared by all coroutines in the same "thread
 * of execution" that was created using ASIO_NAMESPACE::co_spawn.
 */
 ...
 * {
 *   co_await ASIO_NAMESPACE::this_coro::reset_cancellation_state(
 *       ASIO_NAMESPACE::enable_partial_cancellation());
 *
 *   // ...
 * } @endcode
 *
 ...
 *   co_await ASIO_NAMESPACE::this_coro::reset_cancellation_state(
 *       ASIO_NAMESPACE::enable_partial_cancellation(),
 *       ASIO_NAMESPACE::disable_cancellation());
 *
 *   // ...
 * } @endcode
 *
 ...
 * @code ASIO_NAMESPACE::awaitable<void> my_coroutine()
 * {
 *   if (co_await ASIO_NAMESPACE::this_coro::throw_if_cancelled)
 *     // ...
 *
 *   // ...
 * } @endcode
 ...
 * @code ASIO_NAMESPACE::awaitable<void> my_coroutine()
 * {
 *   co_await ASIO_NAMESPACE::this_coro::throw_if_cancelled(false);
 *
 *   // ...
 * } @endcode
 */
