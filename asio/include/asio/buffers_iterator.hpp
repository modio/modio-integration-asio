...
public:
...
#endif // defined(__GNUC__) && (__GNUC__ == 4) && (__GNUC_MINOR__ == 3)
  {
    ...
    new_iter.begin_ = ModioAsio::buffer_sequence_begin(buffers);
    new_iter.current_ = ModioAsio::buffer_sequence_begin(buffers);
    new_iter.end_ = ModioAsio::buffer_sequence_end(buffers);
