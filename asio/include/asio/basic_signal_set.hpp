 ...
 * ModioAsio::signal_set signals(my_context, SIGINT, SIGTERM);
 *
...
public:
   ...
   * @code ModioAsio::signal_set signals(ex);
    ...
    : impl_(0, ex)
  {
    ...
    ModioAsio::detail::throw_error(ec, "add");
  }
   ...
   *
   * @note This constructor is equivalent to performing:
   * @code ModioAsio::signal_set signals(context);
   * signals.add(signal_number_1); @endcode
   */
  template <typename ExecutionContext>
  ...
  void remove(int signal_number)
  {
    ...
    ModioAsio::detail::throw_error(ec, "remove");
  }
  ...
  void clear()
  {
    ...
    ModioAsio::detail::throw_error(ec, "clear");
  }
   ...
   * @note Removes all queued notifications.
   */
  ASIO_SYNC_OP_VOID clear(ModioAsio::error_code& ec)
  {
    impl_.get_service().clear(impl_.get_implementation(), ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * operation will be invoked with the ModioAsio::error::operation_aborted
   * error code.
   *
   ...
   * error code ModioAsio::error::operation_aborted.
   *
   ...
   * @code void(ModioAsio::error_code, int) @endcode
   *
   ...
   */
  template <
    ASIO_COMPLETION_TOKEN_FOR(void (ModioAsio::error_code, int))
  ...
  async_wait(
    ...
    ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      async_initiate<SignalToken, void (ModioAsio::error_code, int)>(
          declval<initiate_async_wait>(), token)))
  {
    return async_initiate<SignalToken, void (ModioAsio::error_code, int)>(
