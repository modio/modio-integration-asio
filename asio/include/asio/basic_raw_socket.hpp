...
public:
   ...
   * @code socket.send(ModioAsio::buffer(data, size)); @endcode
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(ModioAsio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * ModioAsio::ip::udp::endpoint destination(
   *     ModioAsio::ip::address::from_string("1.2.3.4"), 12345);
   * socket.send_to(ModioAsio::buffer(data, size), destination);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
      ...
      const endpoint_type& destination)
  {
    ...
    ModioAsio::detail::throw_error(ec, "send_to");
    return s;
  }
   ...
   *     ModioAsio::buffer(data, size), destination, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code socket.receive(ModioAsio::buffer(data, size)); @endcode
   ...
   * follows:
   * @code
   * socket.async_receive(ModioAsio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * ModioAsio::ip::udp::endpoint sender_endpoint;
   * socket.receive_from(
   *     ModioAsio::buffer(data, size), sender_endpoint);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
      ...
      endpoint_type& sender_endpoint)
  {
    ...
    ModioAsio::detail::throw_error(ec, "receive_from");
    return s;
  }
   ...
   *     ModioAsio::buffer(data, size), 0, sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   *
