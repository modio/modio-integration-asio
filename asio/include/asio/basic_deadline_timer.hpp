 ...
 *
 * Most applications will use the ModioAsio::deadline_timer typedef.
 *
 * @par Thread Safety
 ...
 * ModioAsio::deadline_timer timer(my_context);
 *
 ...
 * @endcode
 *
 * @li The ModioAsio::basic_deadline_timer::expires_from_now() function
...
template <typename Time,
    typename TimeTraits = ModioAsio::time_traits<Time>,
