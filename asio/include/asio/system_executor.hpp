...
private:
   ...
   *
   * For example:
   * @code ASIO_NAMESPACE::system_executor ex1;
...
private:
  ...
  friend struct ASIO_NAMESPACE::execution::detail::blocking_t<0>;
  ...
  friend struct ASIO_NAMESPACE::execution::detail::relationship_t<0>;
#endif // !defined(GENERATING_DOCUMENTATION)
   ...
   *
   * For example:
   * @code ASIO_NAMESPACE::system_executor ex;
   ...
   * For example:
   * @code ASIO_NAMESPACE::system_executor ex;
   * ASIO_NAMESPACE::system_context& pool = ASIO_NAMESPACE::query(
...
struct equality_comparable<
    ASIO_NAMESPACE::basic_system_executor<Blocking, Relationship, Allocator>
  >
{
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef ASIO_NAMESPACE::basic_system_executor<
      ASIO_NAMESPACE::execution::blocking_t::possibly_t,
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef ASIO_NAMESPACE::basic_system_executor<Blocking,
      ASIO_NAMESPACE::execution::relationship_t::fork_t,
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef ASIO_NAMESPACE::system_context& result_type;
};
...
struct query_member<
    ASIO_NAMESPACE::basic_system_executor<Blocking, Relationship, Allocator>,
    ASIO_NAMESPACE::execution::allocator_t<Allocator>
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
