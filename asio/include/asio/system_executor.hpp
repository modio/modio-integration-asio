...
private:
   ...
   *
   * For example:
   * @code ModioAsio::system_executor ex1;
...
private:
   ...
   *
   * For example:
   * @code ModioAsio::system_executor ex;
   ...
   * For example:
   * @code ModioAsio::system_executor ex;
   * ModioAsio::system_context& pool = ModioAsio::query(
...
struct equality_comparable<
    ModioAsio::basic_system_executor<Blocking, Relationship, Allocator>
  >
{
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef ModioAsio::basic_system_executor<
      ModioAsio::execution::blocking_t::possibly_t,
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef ModioAsio::basic_system_executor<Blocking,
      ModioAsio::execution::relationship_t::fork_t,
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef ModioAsio::system_context& result_type;
};
...
struct query_member<
    ModioAsio::basic_system_executor<Blocking, Relationship, Allocator>,
    ModioAsio::execution::allocator_t<Allocator>
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
