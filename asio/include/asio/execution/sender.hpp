...
struct has_sender_traits<S,
    typename enable_if<
      is_same<
        typename ModioAsio::execution::sender_traits<
...
#define ASIO_EXECUTION_SENDER ::ModioAsio::execution::sender
...
#define ASIO_EXECUTION_SENDER_TO(r) \
  ::ModioAsio::execution::sender_to<r>
...
#define ASIO_EXECUTION_TYPED_SENDER \
  ::ModioAsio::execution::typed_sender
