...
public:
   ...
   *
   * @throws ASIO_NAMESPACE::system_error Thrown on failure. If the notification
   ...
   * constructor.
   *
   * @throws ASIO_NAMESPACE::service_already_exists Thrown if a service of the
...
#undef ASIO_PRIVATE_MAKE_SERVICE_DEF
   ...
   * given type is already present in the execution_context.
   *
   * @throws ASIO_NAMESPACE::invalid_service_owner Thrown if the service's owning
...
private:
  ...
  ASIO_NAMESPACE::detail::service_registry* service_registry_;
};
...
private:
  ...
  friend class ASIO_NAMESPACE::detail::service_registry;
  struct key
  {
