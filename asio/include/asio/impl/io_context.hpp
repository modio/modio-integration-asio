...
struct io_context::initiate_post
{
      ...
      io_context* self) const
  {
    ...
    bool is_continuation =
      ModioAsio::asio_handler_cont_helpers::is_continuation(handler2.value);
...
#if !defined(ASIO_NO_DEPRECATED)
inline io_context::work::work(ModioAsio::io_context& io_context)
...
inline ModioAsio::io_context& io_context::work::get_io_context()
{
  return static_cast<ModioAsio::io_context&>(io_context_impl_.context());
}
#endif // !defined(ASIO_NO_DEPRECATED)

inline ModioAsio::io_context& io_context::service::get_io_context()
{
  return static_cast<ModioAsio::io_context&>(context());
}
