...
namespace detail
{
      ...
      ModioAsio::error_code& ec)
  {
    ...
    ModioAsio::detail::consuming_buffers<mutable_buffer,
    ...
    uint64_t offset, const MutableBufferSequence& buffers)
{
  ...
  ModioAsio::detail::throw_error(ec, "read_at");
...
template <typename SyncRandomAccessReadDevice, typename Allocator,
    typename CompletionCondition>
std::size_t read_at(SyncRandomAccessReadDevice& d,
    uint64_t offset, ModioAsio::basic_streambuf<Allocator>& b,
    CompletionCondition completion_condition, ModioAsio::error_code& ec)
{
  ec = ModioAsio::error_code();
...
namespace detail
{
  ...
  //private:
    typedef ModioAsio::detail::consuming_buffers<mutable_buffer,
...
namespace detail
{
  ...
  //private:
    AsyncRandomAccessReadDevice& device_;
    uint64_t offset_;
    ModioAsio::basic_streambuf<Allocator>& streambuf_;
    int start_;
