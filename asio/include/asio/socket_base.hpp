...
public:
   ...
   * Setting the option:
   * @code
   * ASIO_NAMESPACE::ip::udp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::broadcast option(true);
   ...
   * ASIO_NAMESPACE::ip::udp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::broadcast option;
...
#else
  typedef ASIO_NAMESPACE::detail::socket_option::boolean<
   ...
   * ...
   * ASIO_NAMESPACE::socket_base::debug option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::debug option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * ASIO_NAMESPACE::ip::udp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::do_not_route option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_NAMESPACE::ip::udp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::do_not_route option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::keep_alive option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::keep_alive option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::send_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::send_buffer_size option;
   * socket.get_option(option);
...
#else
  typedef ASIO_NAMESPACE::detail::socket_option::integer<
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::send_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::send_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::receive_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::receive_buffer_size option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::receive_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::receive_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ...
   * ASIO_NAMESPACE::socket_base::reuse_address option(true);
   ...
   * ASIO_NAMESPACE::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::reuse_address option;
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::linger option(true, 30);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::linger option;
   * socket.get_option(option);
...
#else
  typedef ASIO_NAMESPACE::detail::socket_option::linger<
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::out_of_band_inline option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::out_of_band_inline option;
   * socket.get_option(option);
   ...
   * operation is permitted to fail with ASIO_NAMESPACE::error::connection_aborted.
   ...
   * ASIO_NAMESPACE::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::enable_connection_aborted option(true);
   * acceptor.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_NAMESPACE::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::enable_connection_aborted option;
   * acceptor.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
...
#else
  typedef ASIO_NAMESPACE::detail::socket_option::boolean<
    ASIO_NAMESPACE::detail::custom_socket_option_level,
    ASIO_NAMESPACE::detail::enable_connection_aborted_option>
   ...
   * ASIO_NAMESPACE::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_NAMESPACE::socket_base::bytes_readable command(true);
...
#else
  typedef ASIO_NAMESPACE::detail::io_control::bytes_readable bytes_readable;
#endif
