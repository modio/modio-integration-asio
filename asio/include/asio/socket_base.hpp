...
public:
   ...
   * Setting the option:
   * @code
   * ModioAsio::ip::udp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::broadcast option(true);
   ...
   * ModioAsio::ip::udp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::broadcast option;
   ...
   * ...
   * ModioAsio::socket_base::debug option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::debug option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * ModioAsio::ip::udp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::do_not_route option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ModioAsio::ip::udp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::do_not_route option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::keep_alive option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::keep_alive option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::send_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::send_buffer_size option;
   * socket.get_option(option);
...
#else
  typedef ModioAsio::detail::socket_option::integer<
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::send_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::send_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::receive_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::receive_buffer_size option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::receive_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::receive_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ...
   * ModioAsio::socket_base::reuse_address option(true);
   ...
   * ModioAsio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ModioAsio::socket_base::reuse_address option;
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::linger option(true, 30);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::linger option;
   * socket.get_option(option);
...
#else
  typedef ModioAsio::detail::socket_option::linger<
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::out_of_band_inline option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::out_of_band_inline option;
   * socket.get_option(option);
   ...
   * operation is permitted to fail with ModioAsio::error::connection_aborted.
   ...
   * ModioAsio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ModioAsio::socket_base::enable_connection_aborted option(true);
   * acceptor.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ModioAsio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ModioAsio::socket_base::enable_connection_aborted option;
   * acceptor.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
  ...
  typedef ModioAsio::detail::socket_option::boolean<
    ...
    ModioAsio::detail::enable_connection_aborted_option>
   ...
   * ModioAsio::ip::tcp::socket socket(my_context);
   * ...
   * ModioAsio::socket_base::bytes_readable command(true);
...
#else
  typedef ModioAsio::detail::io_control::bytes_readable bytes_readable;
#endif
