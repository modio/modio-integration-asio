...
public:
  ...
  std::size_t fill(ModioAsio::error_code& ec);
  ...
  /// Determine the amount of data that may be read without blocking.
  std::size_t in_avail(ModioAsio::error_code& ec)
  {
...
private:
  ...
  {
    std::size_t bytes_copied = ModioAsio::buffer_copy(
  ...
  {
    return ModioAsio::buffer_copy(buffers, storage_.data(), storage_.size());
  }
